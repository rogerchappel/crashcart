...
Replace this section with the supported versions for `crashcart`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `crashcart` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in crashcart.
